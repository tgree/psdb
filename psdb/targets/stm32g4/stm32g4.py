...
import psdb
from psdb.devices import MemDevice, stm32g4
...
DEVICES_2 = [(stm32g4.SRAM,    'SRAM1',    0x20000000, 0x00004000),
             ...
             (stm32g4.BT,      'TIM6',     0x40001000),
             (stm32g4.BT,      'TIM7',     0x40001400),
             ...
             (stm32g4.ACT,     'TIM1',     0x40012C00),
             (stm32g4.ACT,     'TIM8',     0x40013400),
             (stm32g4.GPT16x2, 'TIM15',    0x40014000),
             (stm32g4.GPT16x1, 'TIM16',    0x40014400),
             (stm32g4.GPT16x1, 'TIM17',    0x40014800),
             (stm32g4.DMA,     'DMA1',     0x40020000),
             (stm32g4.DMA,     'DMA2',     0x40020400),
             (stm32g4.DMAMUX,  'DMAMUX',   0x40020800),
             (stm32g4.RCC,     'RCC',      0x40021000),
             (stm32g4.FLASH_2, 'FLASH',    0x40022000, 0x08000000, 3300000,
                                           0x1FFF7000, 1024),  # noqa: E127
             (stm32g4.GPIO,    'GPIOA',    0x48000000),
             (stm32g4.GPIO,    'GPIOB',    0x48000400),
             (stm32g4.GPIO,    'GPIOC',    0x48000800),
             (stm32g4.GPIO,    'GPIOD',    0x48000C00),
             (stm32g4.GPIO,    'GPIOE',    0x48001000),
             (stm32g4.GPIO,    'GPIOF',    0x48001400),
             (stm32g4.GPIO,    'GPIOG',    0x48001800),
             (stm32g4.ADC,     'ADC12',    0x50000000, 1, 2),
             (stm32g4.DAC,     'DAC1',     0x50000800),
             (stm32g4.DAC,     'DAC3',     0x50001000),
...
DEVICES_3 = [(stm32g4.SRAM,    'SRAM1',    0x20000000, 0x00014000),
             ...
             (stm32g4.GPIO,    'GPIOG',    0x48001800),
             (stm32g4.ADC,     'ADC12',    0x50000000, 1, 2),
             (stm32g4.ADC,     'ADC345',   0x50000400, 3, 3),
             (stm32g4.DAC,     'DAC1',     0x50000800),
             (stm32g4.DAC,     'DAC2',     0x50000C00),
             (stm32g4.DAC,     'DAC3',     0x50001000),
             (stm32g4.DAC,     'DAC4',     0x50001400),
             (stm32g4.DBGMCU,  'DBGMCU',   0xE0042000),
             ]
...
DEVICES_4 = [(stm32g4.SRAM,    'SRAM1',    0x20000000, 0x00014000),
             ...
             (stm32g4.GPIO,    'GPIOG',    0x48001800),
             (stm32g4.ADC,     'ADC12',    0x50000000, 1, 2),
             (stm32g4.ADC,     'ADC3',     0x50000400, 3, 1),
             (stm32g4.DAC,     'DAC1',     0x50000800),
             (stm32g4.DAC,     'DAC3',     0x50001000),
             (stm32g4.DBGMCU,  'DBGMCU',   0xE0042000),
             ]
